...
alias sz='bundle exec zeus start'
alias zs='bundle exec zeus server'
alias zc='bundle exec zeus console'
alias zt='bundle exec zeus rspec'
alias zr='bundle exec zeus rake'
alias zwork='bundle exec zeus rake jobs:work'
